...
import org.firstinspires.ftc.sixteen750.commands.auto.red.RedStageParkCorner;
import org.firstinspires.ftc.sixteen750.controls.DriverController;
import org.firstinspires.ftc.sixteen750.helpers.StartingPosition;

// The last 4 weird things are '🟥' and '🪶' (wing)
@Autonomous(name = "Push&PlaceCornerRedStage")
...
public class PixelThenParkCornerRedStage extends CommandOpMode {
    ...
    public void uponInit() {
        ...
        CommandScheduler.scheduleForState(new RedStageParkCorner(robot), OpModeState.RUN);
