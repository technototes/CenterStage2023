...
public class StagePixelPlaceRight extends SequentialCommandGroup {
    ...
    public StagePixelPlaceRight(Robot r) {
        super(
                ...
                new TrajectorySequenceCommand(r.drivebase, AutoConstants.StageBlue.MID_CLEAR_TO_RIGHT_SPIKE),
                new TrajectorySequenceCommand(r.drivebase, AutoConstants.StageBlue.RIGHT_SPIKE_TO_MID_CLEAR),
                ...
                new TrajectorySequenceCommand(r.drivebase, AutoConstants.StageBlue.LEFT_CLEAR_TO_PLACE_RIGHT),
                //place command
                new TrajectorySequenceCommand(r.drivebase, AutoConstants.StageBlue.PLACE_RIGHT_TO_MID_PARK_CENTER)
        );
    }
}
