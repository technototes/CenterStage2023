...
import org.firstinspires.ftc.sixteen750.commands.auto.red.RedWingParkCenter;
import org.firstinspires.ftc.sixteen750.controls.DriverController;
import org.firstinspires.ftc.sixteen750.helpers.StartingPosition;

// The last 4 weird things are '🟥' and '🪶' (wing)
@Autonomous(name = "Push&PlaceCenterRedWing")
...
public class PixelThenParkCenterRedWing extends CommandOpMode {
    ...
    public void uponInit() {
        ...
        CommandScheduler.scheduleForState(new RedWingParkCenter(robot), OpModeState.RUN);
