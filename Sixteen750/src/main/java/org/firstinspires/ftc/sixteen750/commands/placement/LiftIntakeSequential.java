...
public class LiftIntakeSequential extends SequentialCommandGroup {
    ...
    public LiftIntakeSequential(PlacementSubsystem s) {
        super(new ScoreHoldCommand(s), new WaitCommand(0.2), new ArmHoldCommand(s), new WaitCommand(0.3), new LiftIntakeCommand(s), new WaitCommand(0.3), new ServoIntakes(s));
    }
}
