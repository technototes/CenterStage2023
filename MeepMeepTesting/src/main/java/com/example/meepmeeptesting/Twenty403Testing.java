...
public class Twenty403Testing {
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
            ...
            .followTrajectorySequence(drive -> getRedTrayectory(drive));
        try {
    ...
    private static TrajectorySequence getRedTrayectory(DriveShim drive) {
        return drive
            ...
            .addTrajectory(AutoConstantsRed.Wing.SPLINE_START_TO_MIDSPIKE.get())
                .addTrajectory(AutoConstantsRed.Wing.SPLINE_MIDSPIKE_TO_START.get())
