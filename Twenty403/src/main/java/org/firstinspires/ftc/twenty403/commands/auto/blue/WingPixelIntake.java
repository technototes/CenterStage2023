...
public class WingPixelIntake extends SequentialCommandGroup {
    ...
    public WingPixelIntake(Robot r) {
        super(
            ...
            //neutral position
            new ParallelCarry(r),
            new TrajectorySequenceCommand(r.drivebaseSubsystem, AutoConstants.WingBlue.MID_PARK_CENTER_TO_PLACE_MIDDLE),
            // pixel scoring
            new PixelScoring(r.armSubsystem),
            new TrajectorySequenceCommand(r.drivebaseSubsystem, AutoConstants.WingBlue.PLACE_MIDDLE_TO_MID_PARK_CENTER)
        );
    }
}
